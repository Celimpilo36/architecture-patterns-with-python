...
class TestBatches(unittest.TestCase):
    ...
    def test_allocating_to_a_batch_reduces_the_aailable_quantity(self):
    ...
    def test_cannot_allocate_if_skus_do_not_match(self):
        ...
        diff_sku_line = OrderLine("order-123", "EXPENSIVE-TOASTER",10)

        self.assertFalse(batch.can_allocate(diff_sku_line))
    ...
    def test_can_only_deallocate_allocated_lines(self):
        ...
        self.assertTrue(batch.available_quantity == 20)
